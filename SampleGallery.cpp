...
static const int SAMPLE_GALLERY_COUNT = 35;
static CGallerySample Samples[] = {
		...
		{ ID_SAMPLE_LEVERELBOW, IDS_SAMPLE_LEVERELBOW, LEVERELBOW_XML },
		{ ID_SAMPLE_ROSSYOKE, IDS_SAMPLE_ROSSYOKE, ROSSYOKE_XML },
		{ ID_SAMPLE_GEARRHOMBIC, IDS_SAMPLE_GEARRHOMBIC, GEARRHOMBIC_XML },
		{ ID_SAMPLE_TRAMMEL, IDS_SAMPLE_TRAMMEL, TRAMMEL_XML },
		{ 0, 0 }
		};
